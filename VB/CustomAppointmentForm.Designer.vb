...
'			Me.btnOK.Click += New System.EventHandler(Me.btnOK_Click);
			...
			Me.petsBindingSource.DataSource = Me.carsDBDataSet
			' 
			' carsDBDataSet
			' 
...
'			Me.dgvInvoices.DefaultValuesNeeded += New System.Windows.Forms.DataGridViewRowEventHandler(Me.dgvInvoices_DefaultValuesNeeded);
			' 
			' ColumnId
			' 
