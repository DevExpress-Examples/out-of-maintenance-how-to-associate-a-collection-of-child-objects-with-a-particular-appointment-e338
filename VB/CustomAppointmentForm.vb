...
Namespace SchedulerAppointmentChildObjects
    Partial Public Class CustomAppointmentForm
        ...
        Public Sub New(ByVal control As SchedulerControl, ByVal apt As Appointment)
            ...
            AddHandler carsDBDataSet_Renamed.Pets.TableNewRow, AddressOf Pets_TableNewRow
        End Sub
        ...
        Private Sub UpdateForm()
            ...
            Try
                ...
                petsTableAdapter.FillBy(carsDBDataSet_Renamed.Pets, controller.AppointmentId)
            Finally
                ResumeUpdate()
            End Try
            UpdateIntervalControls()
        ...
        Private Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOK.Click
            ...
            ' Save Invoices
            controller.Invoices = DirectCast(DirectCast(dgvInvoices.DataSource, BindingSource).DataSource, List(Of Invoice))
            ...
            If isNewApt Then
                For i As Integer = 0 To carsDBDataSet_Renamed.Pets.Rows.Count - 1
                    carsDBDataSet_Renamed.Pets.Rows(i)("OwnerID") = controller.AppointmentId
                Next i
            End If
            petsTableAdapter.Update(carsDBDataSet_Renamed.Pets)
        End Sub
        #End Region
                ...
                Get
                    ...
                    Else
                        ...
                        Using stringReader As New StringReader(val.ToString())
                            result = DirectCast(xmlFormat.Deserialize(stringReader), List(Of Invoice))
                        End Using
